...
namespace path2image {
	...
	const std::string bomb("images/explosions/type_C.png");
	const std::string fruit("images/fruit.png");
	const std::string rock("images/rocknew.png");
	...
	const std::string spark{ "images/circle.png" };
	const std::string fog{ "images/fog.png" };
